...
enum BadMessageReason {
  ...
  OBSOLETE_RFH_RECEIVED_INVALID_BROWSING_TOPICS_ATTRIBUTE = 299,
  ...
  OBSOLETE_RFH_RECEIVED_INVALID_SHARED_STORAGE_WRITABLE_ATTRIBUTE = 306,
  ...
  OBSOLETE_RFH_ORIENTATION_LOCK_FROM_SANDBOXED_FRAME = 362,
  ...
  OBSOLETE_RFH_BLOB_URL_STORE_ASSOCIATED_PDF_PROCESS_BLOCKED = 372,
  OBSOLETE_RFH_BLOB_URL_STORE_RECEIVER_PDF_PROCESS_BLOCKED = 373,
  ...
  RFH_CREATE_CHILD_FRAME_INVALID_INITIATOR_TOKEN = 379,
  RFH_COMMIT_NAVIGATION_INVALID_TRANSITION_TYPE = 380,
  RFH_COMMIT_NAVIGATION_NON_WEBBY_TRANSITION = 381,
  RFH_COMMIT_NAVIGATION_TRANSITION_FRAME_TYPE_MISMATCH = 382,
  ...
  RFH_CREATE_CHILD_FRAME_EMPTY_UNIQUE_NAME = 386,
  RFH_DID_CHANGE_NAME_EMPTY_UNIQUE_NAME = 387,

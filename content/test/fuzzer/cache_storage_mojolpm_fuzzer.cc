...
void CacheStorageTestcase::SetUp(base::OnceClosure done_closure) {
  ...
  cache_storage_receiver_ = cache_storage_remote_.BindNewPipeAndPassReceiver();
...
void CacheStorageTestcase::SetUpOnUIThread(base::OnceClosure done_closure) {
...
void CacheStorageTestcase::SetUpOnFuzzerThread(base::OnceClosure done_closure) {
...
void CacheStorageTestcase::TearDownOnUIThread(base::OnceClosure done_closure) {
...
DEFINE_BINARY_PROTO_FUZZER(
  ...
  content::GetFuzzerTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(&::mojolpm::RunTestcase<content::CacheStorageTestcase>,
